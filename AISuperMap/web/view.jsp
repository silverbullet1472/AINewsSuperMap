...
<section id="ave_map">
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            type: 'GET',
            url: 'df_byid_located_loged_absed.csv',
            success: function (data) {
                layer.setData(data, {
                    type: 'csv',
                    lnglat: 'lnglat'
...
<section id="link_map">
    ...
    <script src="assets/js/city_line.js"></script>
    <script type="text/javascript">
...
<section id="stats">
    ...
    <script type="text/javascript" src="assets/js/stats_data.js"></script>
